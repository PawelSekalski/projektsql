...
INSERT INTO blood_donor (donor_firstname, donor_lastname, donor_email, birth_date) values ('Tom', 'Hardy', 'tommy.h@th.com', '1977-03-17');
...
INSERT INTO blood_transport (transport_date, blood_type, transport_quantity, id_request) values ('2017-08-04', 'B Rh-', 2000, 17);
...
# update mr Hieronim Ptak email adress to 'abc@gmail.xyz'

UPDATE blood_donor 
SET 
    donor_email = 'abc@gmail.xyz'
WHERE
    donor_firstname = 'Hieronim'
        AND donor_lastname = 'Ptak';
        
# show informations about donor whose last name is Ptak
